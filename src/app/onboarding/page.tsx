...
export default async function OnboardingPage() {
  ...
  return (
    <div className="relative grid min-h-dvh place-items-center overflow-hidden px-4 py-10 sm:px-8">
      ...
      <div className="relative z-10 flex w-full justify-center"><OnboardingFlow /></div>
    </div>
  )
}
