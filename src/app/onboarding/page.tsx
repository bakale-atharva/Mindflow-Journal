...
export default async function OnboardingPage() {
  ...
  return (
    <div className="relative flex min-h-dvh justify-center overflow-hidden px-4 py-6 sm:px-8 lg:px-12 lg:py-8">
      <ThoughtContour
        compact
        className="pointer-events-none absolute -left-20 top-12 w-105 rotate-[-10deg] opacity-55"
      />
      <ThoughtContour
        mood={5}
        compact
        className="pointer-events-none absolute -bottom-16 -right-24 w-115 rotate-12 opacity-45"
      />
