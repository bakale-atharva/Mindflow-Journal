...
export function ThoughtContour({ mood, compact = false, className }: { mood?: number | null; compact?: boolean; className?: string }) {
  return (
    <div className={cn('thought-contour', compact && 'thought-contour--compact', className)} data-mood={mood ?? 3} aria-hidden="true">
      ...
      <svg className="thought-contour__lines" viewBox="0 0 560 360" fill="none" preserveAspectRatio="xMidYMid slice">
